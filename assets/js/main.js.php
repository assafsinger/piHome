...
function getdevices(){  
    ...
    $.get( "index.php?c=home&a=getlights", function( data ) {  
        ...
        {                                
            ...
            html += '<div class="col-xs-6 col-sm-6 col-md-6" style="width:50%"><div class="device">'+value.device+sunset+'</div><small>'+value.room + ((typeof value.tempData.temp !== 'undefined') ? ' | Temp:'+value.tempData.temp+'°, Humidity:'+value.tempData.hum +'%' : '') + '</small></div>';
            html += '<div class="col-xs-5 col-sm-5 col-md-5" style="min-width:190px">';
